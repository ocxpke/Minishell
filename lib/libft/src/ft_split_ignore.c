 ...
 * @param c The delimiter character that separates tokens.
 ...
 */
static char	*extract_token(const char **s, char c, char const *ignore)
{
	const char	*start;
	size_t		len;
	int			inside_ignore;
 ...
 */
static char	**set_substrs(char const *s, char c, size_t token_count,
		char const *ignore)
{
	char	**str_cont;
	size_t	substr_count;
 ...
 */
static size_t	count_tokens(char const *s, char c, char const *ignore)
{
	size_t	counter;
	int		inside_token;
	int		inside_ignore;
